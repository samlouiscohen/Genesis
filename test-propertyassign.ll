...
entry:
  ...
  %cl2 = load i32, i32* %cl
  %1 = call i32 @setX(i32 %cl2, i32 100)
  %color_tmp3 = alloca %color
  %clr_ptr4 = alloca %color*
  %r5 = getelementptr inbounds %color, %color* %color_tmp3, i32 0, i32 0
  store i32 0, i32* %r5
  %g6 = getelementptr inbounds %color, %color* %color_tmp3, i32 0, i32 1
  store i32 0, i32* %g6
  %b7 = getelementptr inbounds %color, %color* %color_tmp3, i32 0, i32 2
  store i32 0, i32* %b7
  store %color* %color_tmp3, %color** %clr_ptr4
  %2 = load %color*, %color** %clr_ptr4
  store %color* %2, %color** %c
  %c8 = load %color*, %color** %c
  call void @startGame(%color* %c8, i32 640, i32 480)
